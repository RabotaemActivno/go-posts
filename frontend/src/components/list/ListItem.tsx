...
function ListItem({post, handlerRemovePost, handlerUpdatePost}: ListProps) {
    ...
    return (
        <li className="list-row bg-primary mb-2">
            ...
            <button className="btn btn-square btn-ghost" onClick={updatePost}>
                Update
            </button>
        </li>
    )
